...
<div id="paoc_unlock_tabs" class="paoc-vtab-cnt paoc_unlock_tabs paoc-clearfix">
	<h2 class="poac-plugin-list">Bundle Deal Details</h2>
	...
	<div class="poac-favourite-section">
		<h3 class="popupaoc-blue poac-favourite-heading">Use Essential Plugin Bundle</h3>
		<h1 class="poac-favourite-sub-heading">With Your Favourite Page Builders</h1>
		<span><i class="dashicons dashicons-yes"></i> = <img src="<?php echo esc_url( POPUPAOC_URL ); ?>assets/images/essential-logo-small.png" width="15" height="15" /> Essential Plugin Bundle contain many more layouts and designs</span>
	</div>

	<div class="poac-upgrade-image-wrap">
		<img src="<?php echo esc_url( POPUPAOC_URL ); ?>assets/images/image-upgrade.png" alt="image-upgrade" title="image-upgrade" />
	</div>
	<div class="poac-deal-offer-wrap">
		<div class="poac-deal-offer"> 
			<div class="poac-inn-deal-offer">
				...
				<h4 class="poac-inn-deal-sub-hedding"><span style="color:red;">Extra Bonus: </span>Users will get <span>15% off</span> on the regular price using this coupon code.</h4>
			</div>
			<div class="poac-inn-deal-offer-btn">
				<div class="poac-inn-deal-code"><span>EPS15</span></div>
				<a href="<?php echo POPUPAOC_PLUGIN_BUNDLE_LINK; ?>"  target="_blank" class="popupaoc-sf-btn popupaoc-sf-btn-orange"><span class="dashicons dashicons-cart"></span> Get Essential Bundle Now</a>
			</div>
		</div>
	</div>
</div>