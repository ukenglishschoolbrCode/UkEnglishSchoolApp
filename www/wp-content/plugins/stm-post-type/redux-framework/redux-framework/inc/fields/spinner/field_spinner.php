...
if ( ! class_exists( 'ReduxFramework_spinner' ) ) {
	...
	class ReduxFramework_spinner {
		...
		public function render() {
			...
			echo '<input type="text" ' . esc_attr( $data_string ) . ' name="' . esc_attr( $this->field['name'] ) . esc_attr( $this->field['name_suffix'] ) . '" id="' . esc_attr( $this->field['id'] ) . '" value="' . esc_attr( $this->value ) . '" class="mini spinner-input ' . esc_attr( $this->field['class'] ) . '"' . esc_attr( $readonly ) . '/>';
			echo '</div>';
		} //function
