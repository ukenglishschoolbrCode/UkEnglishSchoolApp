...
function gamipress_h5p_activity_triggers( $triggers ) {
    ...
    $triggers[__( 'H5P', 'gamipress-h5p-integration' )] = array(
        ...
        // Min percentage
        'gamipress_h5p_complete_content_min_percentage'                  => __( 'Complete any interactive content with a minimum percentage score', 'gamipress-h5p-integration' ),
        'gamipress_h5p_complete_specific_content_min_percentage'         => __( 'Complete a specific interactive content with a minimum percentage score', 'gamipress-h5p-integration' ),
        'gamipress_h5p_complete_specific_content_type_min_percentage'    => __( 'Complete any interactive content of a specific type with a minimum percentage score', 'gamipress-h5p-integration' ),
        
        // Max percentage
        'gamipress_h5p_complete_content_max_percentage'                  => __( 'Complete any interactive content with a maximum percentage score', 'gamipress-h5p-integration' ),
        'gamipress_h5p_complete_specific_content_max_percentage'         => __( 'Complete a specific interactive content with a maximum percentage score', 'gamipress-h5p-integration' ),
        'gamipress_h5p_complete_specific_content_type_max_percentage'    => __( 'Complete any interactive content of a specific type with a maximum percentage score', 'gamipress-h5p-integration' ),

        // Between percentage
        'gamipress_h5p_complete_content_between_percentage'                  => __( 'Complete any interactive content on a range of percentages scores', 'gamipress-h5p-integration' ),
        'gamipress_h5p_complete_specific_content_between_percentage'         => __( 'Complete a specific interactive content on a range of percentages scores', 'gamipress-h5p-integration' ),
        'gamipress_h5p_complete_specific_content_type_between_percentage'    => __( 'Complete any interactive content of a specific type on a range of percentages scores', 'gamipress-h5p-integration' ),
    );
...
function gamipress_h5p_activity_trigger_label( $title, $requirement_id, $requirement ) {
    ...
    switch( $requirement['trigger_type'] ) {
        ...
        case 'gamipress_h5p_complete_content_min_percentage':
            return sprintf( __( 'Completed an interactive content with a percentage score of %d or higher', 'gamipress-h5p-integration' ), $percentage );
            break;
        case 'gamipress_h5p_complete_specific_content_min_percentage':
            $achievement_post_id = absint( $requirement['achievement_post'] );
            return sprintf( __( 'Complete %s with a percentage score of %d or higher', 'gamipress-h5p-integration' ), gamipress_h5p_get_content_title( $achievement_post_id ), $percentage );
            break;
        case 'gamipress_h5p_complete_specific_content_type_min_percentage':
            if( $content_type !== '' )
                return sprintf( __( 'Complete a %s with a percentage score of %d or higher', 'gamipress-h5p-integration' ), gamipress_h5p_get_content_type_title( $content_type ), $percentage );
            break;

        // Max percentage
        case 'gamipress_h5p_complete_content_max_percentage':
            return sprintf( __( 'Completed an interactive content with a percentage score of %d or lower', 'gamipress-h5p-integration' ), $percentage );
            break;
        case 'gamipress_h5p_complete_specific_content_max_percentage':
            $achievement_post_id = absint( $requirement['achievement_post'] );
            return sprintf( __( 'Complete %s with a percentage score of %d or lower', 'gamipress-h5p-integration' ), gamipress_h5p_get_content_title( $achievement_post_id ), $percentage );
            break;
        case 'gamipress_h5p_complete_specific_content_type_max_percentage':
            if( $content_type !== '' )
                return sprintf( __( 'Complete a %s with a percentage score of %d or lower', 'gamipress-h5p-integration' ), gamipress_h5p_get_content_type_title( $content_type ), $percentage );
            break;

        // Between percentages
        case 'gamipress_h5p_complete_content_between_percentage':
            return sprintf( __( 'Completed an interactive content with a percentage score between %d and %d', 'gamipress-h5p-integration' ), $min_score, $max_score );
            break;
        case 'gamipress_h5p_complete_specific_content_between_percentage':
            $achievement_post_id = absint( $requirement['achievement_post'] );
            return sprintf( __( 'Complete %s with a percentage score between %d and %d', 'gamipress-h5p-integration' ), gamipress_h5p_get_content_title( $achievement_post_id ), $min_score, $max_score );
            break;
        case 'gamipress_h5p_complete_specific_content_type_between_percentage':
            if( $content_type !== '' )
                return sprintf( __( 'Complete a %s with a percentage score between %d and %d', 'gamipress-h5p-integration' ), gamipress_h5p_get_content_type_title( $content_type ), $min_score, $max_score );
            break;
...
function gamipress_h5p_log_extra_data_fields( $fields, $log_id, $type ) {
    ...
    switch( $trigger ) {
        ...
        case 'gamipress_h5p_complete_specific_content_type_between_percentage':
            $fields[] = array(
                'name' 	            => __( 'Percentage Score', 'gamipress-h5p-integration' ),
                'desc' 	            => __( 'Percentage score attached to this log.', 'gamipress-h5p-integration' ),
