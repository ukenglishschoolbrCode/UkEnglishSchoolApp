...
function gamipress_masterstudy_lms_activity_triggers( $triggers ) {
    ...
    $triggers[__( 'MasterStudy LMS', 'gamipress-masterstudy-lms-integration' )] = array(
        // Quiz
        'gamipress_masterstudy_lms_complete_quiz' => __( 'Complete a quiz', 'gamipress-masterstudy-lms-integration' ),
        'gamipress_masterstudy_lms_complete_specific_quiz' => __( 'Complete a specific quiz', 'gamipress-masterstudy-lms-integration' ),
        'gamipress_masterstudy_lms_pass_quiz' => __( 'Pass a quiz', 'gamipress-masterstudy-lms-integration' ),
        'gamipress_masterstudy_lms_pass_specific_quiz' => __( 'Pass a specific quiz', 'gamipress-masterstudy-lms-integration' ),
        'gamipress_masterstudy_lms_fail_quiz' => __( 'Fail a quiz', 'gamipress-masterstudy-lms-integration' ),
        'gamipress_masterstudy_lms_fail_specific_quiz' => __( 'Fail a specific quiz', 'gamipress-masterstudy-lms-integration' ),
        // Lesson
        'gamipress_masterstudy_lms_complete_lesson' => __( 'Complete a lesson', 'gamipress-masterstudy-lms-integration' ),
        'gamipress_masterstudy_lms_complete_specific_lesson' => __( 'Complete a specific lesson', 'gamipress-masterstudy-lms-integration' ),
        'gamipress_masterstudy_lms_complete_lesson_specific_course' => __( 'Complete a lesson of a specific', 'gamipress-masterstudy-lms-integration' ),
        // Course
        'gamipress_masterstudy_lms_enroll_course' => __( 'Enroll any course', 'gamipress-masterstudy-lms-integration' ),
        'gamipress_masterstudy_lms_enroll_specific_course' => __( 'Enroll a specific course', 'gamipress-masterstudy-lms-integration' ),
        'gamipress_masterstudy_lms_complete_course' => __( 'Complete a course', 'gamipress-masterstudy-lms-integration' ),
        'gamipress_masterstudy_lms_complete_specific_course' => __( 'Complete a specific course', 'gamipress-masterstudy-lms-integration' ),
        'gamipress_masterstudy_lms_download_course_certificate' => __( 'Download a course certificate', 'gamipress-masterstudy-lms-integration' ),
        'gamipress_masterstudy_lms_download_specific_course_certificate' => __( 'Download a specific course certificate', 'gamipress-masterstudy-lms-integration' ),
    );
...
function gamipress_masterstudy_lms_specific_activity_trigger_label( $specific_activity_trigger_labels ) {
    ...
    // Quiz
    $specific_activity_trigger_labels['gamipress_masterstudy_lms_complete_specific_quiz'] = __( 'Complete the quiz %s', 'gamipress-masterstudy-lms-integration' );
    $specific_activity_trigger_labels['gamipress_masterstudy_lms_pass_specific_quiz'] = __( 'Pass the quiz %s', 'gamipress-masterstudy-lms-integration' );
    $specific_activity_trigger_labels['gamipress_masterstudy_lms_fail_specific_quiz'] = __( 'Fail the quiz %s', 'gamipress-masterstudy-lms-integration' );
    // Lesson
    $specific_activity_trigger_labels['gamipress_masterstudy_lms_complete_specific_lesson'] = __( 'Complete the lesson %s', 'gamipress-masterstudy-lms-integration' );
    $specific_activity_trigger_labels['gamipress_masterstudy_lms_complete_lesson_specific_course'] = __( 'Complete a lesson of the course %s', 'gamipress-masterstudy-lms-integration' );
    // Course
    $specific_activity_trigger_labels['gamipress_masterstudy_lms_enroll_specific_course'] = __( 'Enroll the course %s', 'gamipress-masterstudy-lms-integration' );
    $specific_activity_trigger_labels['gamipress_masterstudy_lms_complete_specific_course'] = __( 'Complete the course %s', 'gamipress-masterstudy-lms-integration' );
    $specific_activity_trigger_labels['gamipress_masterstudy_lms_download_specific_course_certificate'] = __( 'Download the certificate of the course %s', 'gamipress-masterstudy-lms-integration' );
