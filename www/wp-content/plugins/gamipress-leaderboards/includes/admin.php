...
function gamipress_leaderboards_admin_bar_menu( $wp_admin_bar ) {
    ...
    $wp_admin_bar->add_node( array(
        ...
        'parent' => 'gamipress',
        'href'   => admin_url( 'edit.php?post_type=gp_leaderboard' )
    ) );
...
add_action( 'gamipress_init_gp_leaderboard_meta_boxes', 'gamipress_leaderboards_meta_boxes' );
...
function gamipress_leaderboards_on_save_leaderboard( $post_id ) {
    ...
    if( $post->post_type !== 'gp_leaderboard' ) {
        return;
    }
