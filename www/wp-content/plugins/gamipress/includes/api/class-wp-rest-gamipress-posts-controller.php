 ...
 */
class WP_REST_GamiPress_Posts_Controller extends WP_REST_Controller {

    public function __construct() {
        $this->namespace = 'wp/v2';
        $this->rest_base = 'gamipress-posts';
    }
    ...
    public function get_items($request) {
         ...
         * @var Function
         */
        $args       = apply_filters("rest_gamipress_posts_query", $args, $request);
