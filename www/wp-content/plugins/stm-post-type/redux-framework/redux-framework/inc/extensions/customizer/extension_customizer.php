...
if ( ! class_exists( 'ReduxFramework_extension_customizer' ) ) {
	...
	class ReduxFramework_extension_customizer {
		...
		public function __construct( $parent ) {
			...
			if ( isset( $_POST['wp_customize'] ) && 'on' == $_POST['wp_customize'] && isset( $_POST['customized'] ) && ! empty( $_POST['customized'] ) && ! isset( $_POST['action'] ) ) {
				add_action(
		...
		public function add_section( $id, $wp_customize, $args = array() ) {
			...
			$wp_customize->add_section( $section, null, $args );
		...
		public function add_panel( $id, $wp_customize, $args = array() ) {
			...
			$wp_customize->add_panel( $panel, null, $args );
		}
