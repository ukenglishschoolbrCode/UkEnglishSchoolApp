...
class GamiPress_Leaderboard_Table {
    ...
    public function display() {
        ...
        if( gamipress_get_post_field( 'post_type', $this->leaderboard_id ) !== 'gp_leaderboard' ) {
            return;
        }
    ...
    public function parse_query_vars() {
        ...
        if( $query_vars['items_per_page'] !== 0 && ( $query_vars['items_per_page'] < $query_vars['max_items'] || $query_vars['max_items'] === 0 ) ) {
    ...
    public function is_pagination_enabled() {
        return (bool) ( $this->query_vars['items_per_page'] !== 0 && ( $this->query_vars['items_per_page'] < $this->query_vars['max_items'] || $this->query_vars['max_items'] === 0 ) );
    }
