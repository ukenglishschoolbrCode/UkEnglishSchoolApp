(function( $ ) {
    ...
    function gamipress_leaderbaords_toggle_columns( row, e ) {
        ...
        // Initialize row opened/closed class
        if( ! row.hasClass('gamipress-leaderboard-row-open') && ! row.hasClass('gamipress-leaderboard-row-closed') ) {
            row.addClass('gamipress-leaderboard-row-closed');
        }

        var action = 'open';

        if( row.hasClass('gamipress-leaderboard-row-open') ) {
            action = 'close';
        }

        // Switch columns visibility
        ...
        // Toggle row classes
        if( action === 'close' ) {
            row.addClass('gamipress-leaderboard-row-closed').removeClass('gamipress-leaderboard-row-open');
        } else {
            row.addClass('gamipress-leaderboard-row-open').removeClass('gamipress-leaderboard-row-closed');
        }
    }
