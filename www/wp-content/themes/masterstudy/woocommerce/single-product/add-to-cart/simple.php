...
<?php else: ?>
    <a href="<?php echo esc_attr($woo_stm_btn_link) ?>"
       class="single_add_to_cart_button single_add_to_cart_button_link button alt"><?php echo esc_attr($woo_stm_btn_label); ?></a>
<?php endif; ?>
