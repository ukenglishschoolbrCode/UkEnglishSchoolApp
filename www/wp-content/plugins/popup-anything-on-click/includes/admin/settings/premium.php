		...
		<div id="post-body" class="metabox-holder">
			<div id="post-body-content">
				...
				<div style="text-align: center; background: #DCDCDC; margin: 30px 0; padding: 10px 30px 30px 30px;">
					...
					<a href="<?php echo POPUPAOC_PLUGIN_LINK_UPGRADE; ?>" target="_blank" class="popupaoc-sf-btn popupaoc-sf-btn-orange"><span class="dashicons dashicons-cart"></span> View Essential Plugin Bundle</a>
				</div>
